...
INSERT INTO tbl_Customers (customer_id, first_name, last_name, date_of_birth, address, phone_number, email)
...
INSERT INTO tbl_Accounts (account_number, customer_id, account_type, balance)
VALUES (1001, 1, 'Savings', 5000.00);

INSERT INTO tbl_Accounts (account_number, customer_id, account_type, balance)
VALUES (1002, 2, 'Salary', 2500.00);

INSERT INTO tbl_Transactions (transaction_id, account_number, transaction_date, amount, transaction_type)
VALUES (1, 1001, '2023-10-18 10:30:00', 1000.00, 'Deposit');

INSERT INTO tbl_Transactions (transaction_id, account_number, transaction_date, amount, transaction_type)
VALUES (2, 1002, '2023-10-19 14:45:00', 500.00, 'Withdrawal');

INSERT INTO tbl_Employees (employee_id, first_name, last_name, date_of_birth, address, phone_number, email, position, salary)
